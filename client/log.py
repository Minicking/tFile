...
class Log:
    def __init__(self, logName=logName):
        ...
        self.formatter = colorlog.ColoredFormatter(Config.LogFormat, log_colors=log_colors_config)  # 日志输出格式
        self.handle_logs()
    ...
    def handle_logs(self):
        ...
        for dir in dir_list:
            dirPath = os.path.abspath(os.path.dirname(__file__)) + Config.Env_symbol + dir  # 拼接删除目录完整路径
